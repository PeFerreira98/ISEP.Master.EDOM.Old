...
namespace EDOM.CommentReviewRate
{
	...
	/// </summary>
	internal partial class CommentReviewRateExplorer : CommentReviewRateExplorerBase
	{
		/// <summary>
		/// Constructs a new CommentReviewRateExplorer.
		/// </summary>
		public CommentReviewRateExplorer(global::System.IServiceProvider serviceProvider)
	...
	/// <summary>
	/// Control hosted in the CommentReviewRateExplorerToolWindow.
	/// </summary>
	internal abstract class CommentReviewRateExplorerBase : DslShell::ModelExplorerTreeContainer
	{
		/// <summary>
		/// Constructs a new CommentReviewRateExplorerBase.
		/// </summary>
		protected CommentReviewRateExplorerBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuCommandId
		{
			get
			{
				return Constants.CommentReviewRateExplorerMenu;
			}
		}
		...
		{
			get { return global::EDOM.CommentReviewRate.Model.DomainClassId; }
		}
