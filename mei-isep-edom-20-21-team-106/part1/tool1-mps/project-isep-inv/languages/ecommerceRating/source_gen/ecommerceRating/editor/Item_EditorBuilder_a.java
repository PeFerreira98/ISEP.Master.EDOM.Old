...
/*package*/ class Item_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.comment$Enjq;
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.comment$Enjq);
    }
  ...
  private EditorCell createRefCell_1() {
    final SReferenceLink referenceLink = LINKS.rate$Eo0t;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(new Computable<EditorCell>() {
          public EditorCell compute() {
    ...
    if (editorCell.getSRole() == null) {
      editorCell.setReferenceCell(true);
      editorCell.setSRole(LINKS.rate$Eo0t);
    }
    editorCell.setSubstituteInfo(new SReferenceSubstituteInfo(editorCell, referenceLink));
    Iterable<SNode> referenceAttributes = SNodeOperations.ofConcept(AttributeOperations.getAttributeList(myNode, new IAttributeDescriptor.AllAttributes()), CONCEPTS.LinkAttribute$v_);
    Iterable<SNode> currentReferenceAttributes = Sequence.fromIterable(referenceAttributes).where(new IWhereFilter<SNode>() {
  ...
  private EditorCell createCollection_1() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Indent());
    editorCell.setCellId("Collection_z4t05o_h0");
    Style style = new StyleImpl();
  ...
  private EditorCell createConstant_4() {
    ...
    editorCell.setCellId("Constant_z4t05o_a7a");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createConstant_5() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, ":");
    editorCell.setCellId("Constant_z4t05o_b7a");
    Style style = new StyleImpl();
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new AttributesListHandler_z4t05o_c7a(myNode, getEditorContext());
  ...
  private static class AttributesListHandler_z4t05o_c7a extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public AttributesListHandler_z4t05o_c7a(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(AttributesListHandler_z4t05o_c7a.this.getNode(), LINKS.Attributes$Vo_d));
      try {
