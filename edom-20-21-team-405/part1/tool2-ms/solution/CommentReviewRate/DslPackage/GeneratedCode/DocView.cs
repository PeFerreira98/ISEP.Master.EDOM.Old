...
namespace EDOM.CommentReviewRate
{
	...
	/// </summary>
	internal partial class CommentReviewRateDocView : CommentReviewRateDocViewBase
	{
		/// <summary>
		/// Constructs a new CommentReviewRateDocView.
		/// </summary>
		public CommentReviewRateDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class CommentReviewRateDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new CommentReviewRateDocView.
		/// </summary>
		protected CommentReviewRateDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			CommentReviewRateDocDataBase docData = this.DocData as CommentReviewRateDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for CommentReviewRateDocViewBase should be an CommentReviewRateDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::EDOM.CommentReviewRate.CommentReviewRateDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::EDOM.CommentReviewRate.CommentReviewRateDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::EDOM.CommentReviewRate.CommentReviewRateToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::EDOM.CommentReviewRate.CommentReviewRateToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.CommentReviewRateDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::EDOM.CommentReviewRate.CommentReviewRateHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::EDOM.CommentReviewRate.CommentReviewRateHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::EDOM.CommentReviewRate.CommentReviewRateHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
