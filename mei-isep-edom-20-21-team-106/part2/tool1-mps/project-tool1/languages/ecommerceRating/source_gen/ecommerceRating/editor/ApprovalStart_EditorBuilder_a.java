...
/*package*/ class ApprovalStart_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public ApprovalStart_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_uyxa12_a");
  ...
  private EditorCell createConstant_0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "has step");
    editorCell.setCellId("Constant_uyxa12_b0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.step$9MXy;
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.step$9MXy);
    }
