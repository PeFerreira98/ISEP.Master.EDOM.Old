...
public class Utils {
  ...
  public static void createRate(IUser user) {
    ...
    Place item = getPlaceById(Integer.parseInt(itemId));
    if (item == null) {
  ...
  public static void displayItems() {
    for (int i = 0; i < GoogleMaps.Places.size(); i++) {
      System.out.println(GoogleMaps.Places.get(i));
      System.out.println("=======================");
    }
  }

  private static Place getPlaceById(int id) {
    Place itemSelected = null;

    for (int i = 0; i < GoogleMaps.Places.size(); i++) {
      if (GoogleMaps.Places.get(i).Id == id) {
        itemSelected = GoogleMaps.Places.get(i);
        break;
      }
    }
