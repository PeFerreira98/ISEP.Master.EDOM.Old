...
namespace Company.UCUS
{
	...
	/// </summary>
	internal partial class UCUSDocView : UCUSDocViewBase
	{
		/// <summary>
		/// Constructs a new UCUSDocView.
		/// </summary>
		public UCUSDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class UCUSDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new UCUSDocView.
		/// </summary>
		protected UCUSDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			UCUSDocDataBase docData = this.DocData as UCUSDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for UCUSDocViewBase should be an UCUSDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::Company.UCUS.UCUSDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::Company.UCUS.UCUSDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::Company.UCUS.UCUSToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::Company.UCUS.UCUSToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.UCUSDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::Company.UCUS.UCUSHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::Company.UCUS.UCUSHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::Company.UCUS.UCUSHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
