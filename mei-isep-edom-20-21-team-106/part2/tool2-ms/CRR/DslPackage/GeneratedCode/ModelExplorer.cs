...
namespace Edom.CRR
{
	...
	/// </summary>
	internal partial class CRRExplorer : CRRExplorerBase
	{
		/// <summary>
		/// Constructs a new CRRExplorer.
		/// </summary>
		public CRRExplorer(global::System.IServiceProvider serviceProvider)
	...
	/// <summary>
	/// Control hosted in the CRRExplorerToolWindow.
	/// </summary>
	internal abstract class CRRExplorerBase : DslShell::ModelExplorerTreeContainer
	{
		/// <summary>
		/// Constructs a new CRRExplorerBase.
		/// </summary>
		protected CRRExplorerBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuCommandId
		{
			get
			{
				return Constants.CRRExplorerMenu;
			}
		}
		...
		{
			get { return global::Edom.CRR.Model.DomainClassId; }
		}
