...
public class Refactor {
	...
	public static void registerEcorePackages() {
		// Associate the "edom405epsilon" extension with the XMI resource format
		Resource.Factory.Registry.INSTANCE.getExtensionToFactoryMap().put("edom405epsilon", new XMIResourceFactoryImpl());
	...
	public static void main(String[] args) {
		...
		refactoringTransformation("usecasename2uppercase", "http://www.example.org/edom405epsilon", "instances/example1.edom405epsilon", "instances/example1-output1.edom405epsilon");

		refactoringTransformation("removeselfincludedusecase", "http://www.example.org/edom405epsilon", "instances/example1.edom405epsilon", "instances/example1-output2.edom405epsilon");
		
		refactoringTransformation("removeincludesdifferentsubjects", "http://www.example.org/edom405epsilon", "instances/example1.edom405epsilon", "instances/example1-output3.edom405epsilon");
	...
	public static void refactoringTransformation(String module, String metaModel, String modelIn, String modelOut) {
		...
		env.registerMetaModel("edom405epsilon", metaM);
