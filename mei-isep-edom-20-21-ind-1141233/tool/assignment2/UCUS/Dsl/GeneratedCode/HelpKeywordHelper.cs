...
namespace Company.UCUS
{
	...
	/// </remarks>
	public partial class UCUSHelpKeywordHelper : UCUSHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new UCUSHelpKeywordHelper.
		/// </summary>
		protected UCUSHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the UCUSHelpKeywordHelper.
		/// </summary>
		public static UCUSHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class UCUSHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new UCUSHelpKeywordHelperBase.
		/// </summary>
		protected UCUSHelpKeywordHelperBase()
			: base() { }
