    ...
    while (true) {
      ...
      switch (option) {
        case 1:
          ...
          Article newSubject = new Article(subjectName, Description);
          Articles.add(newSubject);
          break;
        ...
        case 2:
          ...
          for (Article sub : Articles) {
            ...
            System.out.println("Comments: " + sub.getArticleComments().toString() + "\n");
          }
          break;
        ...
        case 3:
          ...
          Articles.get(subSelected).addComment(new ArticleComment(Date, Text));
          break;
