...
/*package*/ class Attribute_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new dataTypeSingleRoleHandler_mc4j88_e0(myNode, LINKS.dataType$j4Zb, getEditorContext());
    return provider.createCell();
  }
  private static class dataTypeSingleRoleHandler_mc4j88_e0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public dataTypeSingleRoleHandler_mc4j88_e0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
    ...
    protected EditorCell createChildCell(SNode child) {
      ...
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.dataType$j4Zb, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.dataType$j4Zb, child));
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.dataType$j4Zb);
      }
    }
    @Override
    protected EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.dataType$j4Zb));
      try {
