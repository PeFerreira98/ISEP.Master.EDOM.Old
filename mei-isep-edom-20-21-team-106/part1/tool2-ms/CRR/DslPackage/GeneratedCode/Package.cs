...
namespace Edom.CRR
{
	...
	[VSShell::ProvideStaticToolboxItem("Edom.CRR.CRRToolboxTab",
					...
					Index = 19)]
	[VSShell::ProvideStaticToolboxItem("Edom.CRR.CRRToolboxTab",
					"@ApprovalOutcomeToolboxItem;Edom.CRR.Dsl.dll", 
					"Edom.CRR.ApprovalOutcomeToolboxItem", 
					"CF_TOOLBOXITEMCONTAINER,CF_TOOLBOXITEMCONTAINER_HASH,CF_TOOLBOXITEMCONTAINER_CONTENTS", 
					"ApprovalOutcome", 
					"@ApprovalOutcomeToolboxBitmap;Edom.CRR.Dsl.dll", 
					0xff00ff,
					Index = 20)]
	[VSShell::ProvideStaticToolboxItem("Edom.CRR.CRRToolboxTab",
					...
					Index = 21)]
	[VSShell::ProvideStaticToolboxItem("Edom.CRR.CRRToolboxTab",
					"@ApprovalProcessHasAttributesToolboxItem;Edom.CRR.Dsl.dll", 
					"Edom.CRR.ApprovalProcessHasAttributesToolboxItem", 
					"CF_TOOLBOXITEMCONTAINER,CF_TOOLBOXITEMCONTAINER_HASH,CF_TOOLBOXITEMCONTAINER_CONTENTS", 
					"ApprovalProcessHasAttributes", 
					"@ApprovalProcessHasAttributesToolboxBitmap;Edom.CRR.Dsl.dll", 
					0xff00ff,
					Index = 22)]
	[VSShell::ProvideStaticToolboxItem("Edom.CRR.CRRToolboxTab",
					"@ApprovalStepHasOutcomeToolboxItem;Edom.CRR.Dsl.dll", 
					"Edom.CRR.ApprovalStepHasOutcomeToolboxItem", 
					"CF_TOOLBOXITEMCONTAINER,CF_TOOLBOXITEMCONTAINER_HASH,CF_TOOLBOXITEMCONTAINER_CONTENTS", 
					"ApprovalStepHasOutcome", 
					"@ApprovalStepHasOutcomeToolboxBitmap;Edom.CRR.Dsl.dll", 
					0xff00ff,
					Index = 23)]
	[VSShell::ProvideStaticToolboxItem("Edom.CRR.CRRToolboxTab",
					"@ApprovalStepHasAttributesToolboxItem;Edom.CRR.Dsl.dll", 
					"Edom.CRR.ApprovalStepHasAttributesToolboxItem", 
					"CF_TOOLBOXITEMCONTAINER,CF_TOOLBOXITEMCONTAINER_HASH,CF_TOOLBOXITEMCONTAINER_CONTENTS", 
					"ApprovalStepHasAttributes", 
					"@ApprovalStepHasAttributesToolboxBitmap;Edom.CRR.Dsl.dll", 
					0xff00ff,
					Index = 24)]
	[VSShell::ProvideStaticToolboxItem("Edom.CRR.CRRToolboxTab",
					"@ApprovalStepHasNextStepToolboxItem;Edom.CRR.Dsl.dll", 
					"Edom.CRR.ApprovalStepHasNextStepToolboxItem", 
					"CF_TOOLBOXITEMCONTAINER,CF_TOOLBOXITEMCONTAINER_HASH,CF_TOOLBOXITEMCONTAINER_CONTENTS", 
					"ApprovalStepHasNextStep", 
					"@ApprovalStepHasNextStepToolboxBitmap;Edom.CRR.Dsl.dll", 
					0xff00ff,
					Index = 25)]
	[VSShell::ProvideStaticToolboxItem("Edom.CRR.CRRToolboxTab",
