...
namespace EDOM.CommentReviewRate
{
	...
	/// </summary>
	internal partial class CommentReviewRateDocData : CommentReviewRateDocDataBase
	{
		/// <summary>
		/// Constructs a new CommentReviewRateDocData.
		/// </summary>
		public CommentReviewRateDocData(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) 
	...
	/// <summary>
	/// Class which represents a CommentReviewRate document in memory.
	/// </summary>
	internal abstract partial class CommentReviewRateDocDataBase : DslShell::ModelingDocData
	{
		...
		/// <summary>
		/// Constructs a new CommentReviewRateDocDataBase.
		/// </summary>
		protected CommentReviewRateDocDataBase(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) : base(serviceProvider, editorFactoryId)
		{
		}
		...
		protected override string FormatList
		{
			get
			{
				return global::EDOM.CommentReviewRate.CommentReviewRateDomainModel.SingletonResourceManager.GetString("FormatList"); 
			}
		}
		...
		protected virtual bool HandleBindingFailure(global::System.Exception exception)
		{
			...
			string errorMessage = string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
				global::EDOM.CommentReviewRate.CommentReviewRateDomainModel.SingletonResourceManager.GetString("BindingErrorOccurred"),
				exception.ToString());
		...
		{
			return new DslShell::VsValidationController(this.ServiceProvider, typeof(CommentReviewRateExplorerToolWindow));
		}
		/// <summary>
		...
		protected override global::System.Collections.Generic.IList<global::System.Type> GetDomainModels()
		{
			...
			allTypes.Add(typeof(global::EDOM.CommentReviewRate.CommentReviewRateDomainModel));
		...
		protected virtual global::System.Collections.Generic.IEnumerable<global::System.Type> GetExtensionDomainModels()
		{
			...
			global::System.Collections.Generic.IEnumerable<global::System.Type> extensionDomainModels = this.ExtensionLocator.GetExtendingDomainModels(typeof(global::EDOM.CommentReviewRate.CommentReviewRateDomainModel));
		...
		protected override void Load(string fileName, bool isReload)
		{
			...
			global::EDOM.CommentReviewRate.Model modelRoot = null;
			...
			global::EDOM.CommentReviewRate.CommentReviewRateDomainModel.EnableDiagramRules(this.Store);
			string diagramFileName = fileName + this.DiagramExtension;
			
			modelRoot = global::EDOM.CommentReviewRate.CommentReviewRateSerializationHelper.Instance.LoadModelAndDiagram(serializationResult, this.GetModelPartition(), fileName, this.GetDiagramPartition(), diagramFileName, schemaResolver, this.ValidationController, this.SerializerLocator);
			...
			{	
				...
				throw new global::System.InvalidOperationException(global::EDOM.CommentReviewRate.CommentReviewRateDomainModel.SingletonResourceManager.GetString("CannotOpenDocument"));
			}
			else
			{
						...
						if (itemId != global::Microsoft.VisualStudio.VSConstants.VSITEMID_NIL)
						{
							...
							if (this.diagramDocumentLockHolder == null)
							{
								throw new global::System.InvalidOperationException(string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
													global::EDOM.CommentReviewRate.CommentReviewRateDomainModel.SingletonResourceManager.GetString("CannotCloseExistingDiagramDocument"),
													diagramFileName));
							}
						}
					}
		...
		{
			DslModeling::SerializationResult serializationResult = new DslModeling::SerializationResult();
			global::EDOM.CommentReviewRate.Model modelRoot = (global::EDOM.CommentReviewRate.Model)this.RootElement;
			...
			{
				global::EDOM.CommentReviewRate.CommentReviewRateDiagram diagram = diagrams[0] as global::EDOM.CommentReviewRate.CommentReviewRateDiagram;
				if (diagram != null)
				{
					string diagramFileName = fileName + this.DiagramExtension;
					try
					{
						...
						global::EDOM.CommentReviewRate.CommentReviewRateSerializationHelper.Instance.SaveModelAndDiagram(serializationResult, modelRoot, fileName, diagram, diagramFileName, this.Encoding, false);
					}
					finally
					{
			...
			{
				global::EDOM.CommentReviewRate.CommentReviewRateSerializationHelper.Instance.SaveModel(serializationResult, modelRoot, fileName, this.Encoding, false);
			}
			// Report serialization messages.
			this.SuspendErrorListRefresh();
			try
			...
			if (serializationResult.Failed)
			{	// Save failed.
				throw new global::System.InvalidOperationException(global::EDOM.CommentReviewRate.CommentReviewRateDomainModel.SingletonResourceManager.GetString("CannotSaveDocument"));
			}
		}
		/// <summary>
			...
			if (diagrams.Count > 0)
			{
				...
				if (diagram != null)
				{
					try
					{
						...
						global::EDOM.CommentReviewRate.CommentReviewRateSerializationHelper.Instance.SaveDiagram(serializationResult, diagram, fileName, this.Encoding, false);
					}
					finally
					{
		...
		protected override string SerializedModel
		{
			get
			{
				global::EDOM.CommentReviewRate.Model modelRoot = this.RootElement as global::EDOM.CommentReviewRate.Model;
				string modelFile = string.Empty;
				if (modelRoot != null)
				{
					modelFile = global::EDOM.CommentReviewRate.CommentReviewRateSerializationHelper.Instance.GetSerializedModelString(modelRoot, this.Encoding);
				}
				return modelFile;
			}
		}
