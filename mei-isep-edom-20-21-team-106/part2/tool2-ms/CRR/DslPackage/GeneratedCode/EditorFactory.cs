...
namespace Edom.CRR
{
	...
	/// </summary>
	[global::System.Runtime.InteropServices.Guid(Constants.CRREditorFactoryId)]
	internal partial class CRREditorFactory : CRREditorFactoryBase
	{
		/// <summary>
		/// Constructs a new CRREditorFactory.
		/// </summary>
		public CRREditorFactory(global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class CRREditorFactoryBase : DslShell::ModelingEditorFactory
	{
		/// <summary>
		/// Constructor.
		/// </summary>
		/// <param name="serviceProvider">Service provider used to access VS services.</param>
		protected CRREditorFactoryBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		public override DslShell::ModelingDocData CreateDocData(string fileName, VSShellInterop::IVsHierarchy hierarchy, uint itemId)
		{
			...
			return new CRRDocData(this.ServiceProvider, typeof(CRREditorFactory).GUID);
		}
		...
		protected override DslShell::ModelingDocView CreateDocView(DslShell::ModelingDocData docData, string physicalView, out string editorCaption)
		{
			...
			return new CRRDocView(docData, this.ServiceProvider);
		}
	}
}
