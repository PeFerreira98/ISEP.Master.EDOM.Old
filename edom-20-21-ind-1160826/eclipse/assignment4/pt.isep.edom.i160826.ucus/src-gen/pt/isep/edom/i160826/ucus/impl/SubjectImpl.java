 ...
 * </p>
 * <ul>
 *   <li>{@link pt.isep.edom.i160826.ucus.impl.SubjectImpl#getUsecase <em>Usecase</em>}</li>
 *   <li>{@link pt.isep.edom.i160826.ucus.impl.SubjectImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SubjectImpl extends MinimalEObjectImpl.Container implements Subject {
	...
	protected EClass eStaticClass() {
		return UcusPackage.Literals.SUBJECT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UcusPackage.SUBJECT__NAME, oldName, name));
	}
	...
	public EList<UseCase> getUsecase() {
		if (usecase == null) {
			usecase = new EObjectContainmentEList<UseCase>(UseCase.class, this, UcusPackage.SUBJECT__USECASE);
		}
		return usecase;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case UcusPackage.SUBJECT__USECASE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case UcusPackage.SUBJECT__USECASE:
			return getUsecase();
		case UcusPackage.SUBJECT__NAME:
			return getName();
		}
