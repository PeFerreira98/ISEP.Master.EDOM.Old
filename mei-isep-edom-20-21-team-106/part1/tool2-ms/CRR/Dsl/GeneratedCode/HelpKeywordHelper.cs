...
namespace Edom.CRR
{
	...
	/// </remarks>
	public partial class CRRHelpKeywordHelper : CRRHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new CRRHelpKeywordHelper.
		/// </summary>
		protected CRRHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the CRRHelpKeywordHelper.
		/// </summary>
		public static CRRHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class CRRHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new CRRHelpKeywordHelperBase.
		/// </summary>
		protected CRRHelpKeywordHelperBase()
			: base() { }
