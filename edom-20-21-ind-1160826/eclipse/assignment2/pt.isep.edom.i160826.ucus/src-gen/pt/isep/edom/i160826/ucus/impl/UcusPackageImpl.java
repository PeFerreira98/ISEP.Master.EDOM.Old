...
public class UcusPackageImpl extends EPackageImpl implements UcusPackage {
	...
	public void initializePackageContents() {
		...
		initEReference(getUseCase_Includes(), this.getInclude(), null, "includes", null, 0, -1, UseCase.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getUseCase_Include(), this.getInclude(), this.getInclude_Usecase(), "include", null, 0, 1,
		...
		initEReference(getUseCase_Extends(), this.getExtend(), null, "extends", null, 0, -1, UseCase.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getUseCase_Extend(), this.getExtend(), this.getExtend_Usecase(), "extend", null, 0, 1,
				UseCase.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getInclude_Usecase(), this.getUseCase(), this.getUseCase_Include(), "usecase", null, 1, 1,
		...
		initEReference(getExtend_Usecase(), this.getUseCase(), this.getUseCase_Extend(), "usecase", null, 1, 1,
				Extend.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
