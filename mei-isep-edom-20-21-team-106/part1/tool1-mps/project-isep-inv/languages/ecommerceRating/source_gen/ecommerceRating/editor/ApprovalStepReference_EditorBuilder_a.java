...
/*package*/ class ApprovalStepReference_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public ApprovalStepReference_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_5dzfco_a");
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.step$6BDX;
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.step$6BDX);
    }
