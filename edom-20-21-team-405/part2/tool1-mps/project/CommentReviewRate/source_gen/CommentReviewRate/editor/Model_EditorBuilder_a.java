...
/*package*/ class Model_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createProperty_0() {
    ...
    try {
      ...
      style.set(StyleAttributes.BRACKETS_COLOR, StyleRegistry.getInstance().getSimpleColor(MPSColors.red));
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new SubjectsListHandler_pyq9q9_a2a(myNode, getEditorContext());
  ...
  private static class SubjectsListHandler_pyq9q9_a2a extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public SubjectsListHandler_pyq9q9_a2a(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public SContainmentLink getSLink() {
      return LINKS.Subjects$nleT;
    }
    public SAbstractConcept getChildSConcept() {
      return CONCEPTS.Subject$4v;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(SubjectsListHandler_pyq9q9_a2a.this.getNode(), LINKS.Subjects$nleT));
      try {
