...
namespace Company.UCUS
{
	...
	/// </summary>
	internal partial class UCUSCommandSet : UCUSCommandSetBase
	{
		/// <summary>
		/// Constructs a new UCUSCommandSet.
		/// </summary>
		public UCUSCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class UCUSCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new UCUSCommandSetBase.
		/// </summary>
		protected UCUSCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewUCUSExplorerCommand,
				typeof(UCUSEditorFactory).GUID);
		...
		{
			UCUSExplorerToolWindow explorer = this.UCUSExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		{
			if (this.CurrentUCUSDocData != null && this.CurrentUCUSDocData.Store != null)
			{
				this.CurrentUCUSDocData.ValidationController.Validate(this.CurrentUCUSDocData.GetAllElementsForValidation(), DslValidation::ValidationCategories.Menu);
			}
		}
		...
		internal virtual void OnMenuValidate(object sender, global::System.EventArgs e)
		{
			if (this.CurrentUCUSDocData != null && this.CurrentUCUSDocData.Store != null)
			{
				...
				this.CurrentUCUSDocData.ValidationController.Validate(elementList, DslValidation::ValidationCategories.Menu);
			}
		}
		...
		protected UCUSDocData CurrentUCUSDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as UCUSDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected UCUSDocView CurrentUCUSDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as UCUSDocView;
			}
		}
		...
		/// </summary>
		protected UCUSExplorerToolWindow UCUSExplorerToolWindow
		{
			get
			{
				UCUSExplorerToolWindow explorerWindow = null;
				DslShell::ModelingPackage package = this.ServiceProvider.GetService(typeof(VSShell::Package)) as DslShell::ModelingPackage;

				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(UCUSExplorerToolWindow), true) as UCUSExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				UCUSExplorerToolWindow explorerWindow = this.UCUSExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class UCUSClipboardCommandSet : UCUSClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new UCUSClipboardCommandSet.
		/// </summary>
		public UCUSClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class UCUSClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new UCUSClipboardCommandSetBase.
		/// </summary>
		protected UCUSClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
