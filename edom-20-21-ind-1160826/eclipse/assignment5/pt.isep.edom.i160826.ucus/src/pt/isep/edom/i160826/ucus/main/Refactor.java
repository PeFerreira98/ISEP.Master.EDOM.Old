...
public class Refactor {
	...
	public static void main(String[] args) {
		...
		refactoringTransformation("usecasename2uppercase", "http://www.example.org/ucus", "instances/example1.ucus", "instances/example1-output1.ucus");

		refactoringTransformation("removeselfincludedusecase", "http://www.example.org/ucus", "instances/example1.ucus", "instances/example1-output2.ucus");
		
		refactoringTransformation("removeincludesdifferentsubjects", "http://www.example.org/ucus", "instances/example1.ucus", "instances/example1-output3.ucus");
