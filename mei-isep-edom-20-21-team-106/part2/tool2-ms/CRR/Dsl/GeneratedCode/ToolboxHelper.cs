...
namespace Edom.CRR
{
	...
	public abstract class CRRToolboxHelperBase
	{
		...
		/// <summary>
		/// Toolbox item filter string used to identify ApprovalStepHasSuccessStep connector tool.
		/// </summary>
		public const string ApprovalStepHasSuccessStepFilterString = "ApprovalStepHasSuccessStep.1.0";
		/// <summary>
		/// Toolbox item filter string used to identify ApprovalStepHasFailureStep connector tool.
		/// </summary>
		public const string ApprovalStepHasFailureStepFilterString = "ApprovalStepHasFailureStep.1.0";
		...
		public virtual DslDesign::ModelingToolboxItem GetToolboxItem(string itemId, DslModeling::Store store)
		{
			...
			switch(itemId)
			{
				...
				case "Edom.CRR.RateHasApprovalProcessToolboxItem":
					...
					break;
				case "Edom.CRR.ApprovalStepHasSuccessStepToolboxItem":

					// Add ApprovalStepHasSuccessStep connector tool.
					result = new DslDesign::ModelingToolboxItem(
						"Edom.CRR.ApprovalStepHasSuccessStepToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						26, // Position relative to other items in the same toolbox tab.
						resourceManager.GetString("ApprovalStepHasSuccessStepToolboxItem", resourceCulture), // Localized display name for the item.
						(global::System.Drawing.Bitmap)DslDiagrams::ImageHelper.GetImage(resourceManager.GetObject("ApprovalStepHasSuccessStepToolboxBitmap", resourceCulture)), // Image displayed next to the toolbox item.				
						"Edom.CRR.CRRToolboxTab", // Unique identifier (non-localized) for the toolbox item tab.
						resourceManager.GetString("CRRToolboxTab", resourceCulture), // Localized display name for the toolbox tab.
						"ApprovalStepHasSuccessStep", // F1 help keyword for the toolbox item.
						resourceManager.GetString("ApprovalStepHasSuccessStepToolboxTooltip", resourceCulture), // Localized tooltip text for the toolbox item.
						null, // Connector toolbox items do not have an underlying data object.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
							new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require), 
							new global::System.ComponentModel.ToolboxItemFilterAttribute(ApprovalStepHasSuccessStepFilterString)
						});
					break;
				case "Edom.CRR.ApprovalStepHasFailureStepToolboxItem":

					// Add ApprovalStepHasFailureStep connector tool.
					result = new DslDesign::ModelingToolboxItem(
						"Edom.CRR.ApprovalStepHasFailureStepToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						27, // Position relative to other items in the same toolbox tab.
						resourceManager.GetString("ApprovalStepHasFailureStepToolboxItem", resourceCulture), // Localized display name for the item.
						(global::System.Drawing.Bitmap)DslDiagrams::ImageHelper.GetImage(resourceManager.GetObject("ApprovalStepHasFailureStepToolboxBitmap", resourceCulture)), // Image displayed next to the toolbox item.				
						"Edom.CRR.CRRToolboxTab", // Unique identifier (non-localized) for the toolbox item tab.
						resourceManager.GetString("CRRToolboxTab", resourceCulture), // Localized display name for the toolbox tab.
						"ApprovalStepHasFailureStep", // F1 help keyword for the toolbox item.
						resourceManager.GetString("ApprovalStepHasFailureStepToolboxTooltip", resourceCulture), // Localized tooltip text for the toolbox item.
						null, // Connector toolbox items do not have an underlying data object.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
							new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require), 
							new global::System.ComponentModel.ToolboxItemFilterAttribute(ApprovalStepHasFailureStepFilterString)
						});
					break;
				default:
					break;
