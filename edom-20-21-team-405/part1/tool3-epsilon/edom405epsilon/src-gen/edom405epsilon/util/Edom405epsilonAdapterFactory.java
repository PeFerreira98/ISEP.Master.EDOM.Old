...
public class Edom405epsilonAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected Edom405epsilonSwitch<Adapter> modelSwitch = new Edom405epsilonSwitch<Adapter>() {
		@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link edom405epsilon.User <em>User</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
