...
namespace Edom.CRR
{
	...
	/// </summary>
	internal partial class CRRDocView : CRRDocViewBase
	{
		/// <summary>
		/// Constructs a new CRRDocView.
		/// </summary>
		public CRRDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class CRRDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new CRRDocView.
		/// </summary>
		protected CRRDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			CRRDocDataBase docData = this.DocData as CRRDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for CRRDocViewBase should be an CRRDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::Edom.CRR.CRRDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::Edom.CRR.CRRDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::Edom.CRR.CRRToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::Edom.CRR.CRRToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.CRRDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::Edom.CRR.CRRHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::Edom.CRR.CRRHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::Edom.CRR.CRRHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
