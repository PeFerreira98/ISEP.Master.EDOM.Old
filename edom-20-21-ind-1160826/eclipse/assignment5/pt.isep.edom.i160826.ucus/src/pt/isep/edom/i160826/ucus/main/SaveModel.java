...
public class SaveModel {
	...
	public static void saveModel() {
        ...
        // Create a UseCase
        UseCase myUseCaseReview = factory.createUseCase();
        myUseCaseReview.setName("ReviewProduct");
        
        // Create a UseCase
        UseCase myUseCaseInsert = factory.createUseCase();
        myUseCaseInsert.setName("InsertPicture");
        ...
        myAssociation.setUsecase(myUseCaseReview);

        // Add Association to the Model
        myModel.getAssociation().add(myAssociation);
        
        // Add all UseCases to the Subject
        mySubject.getUsecase().add(myUseCaseReview);
        mySubject.getUsecase().add(myUseCaseInsert);
