 ...
 * </p>
 * <ul>
 *   <li>{@link pt.isep.edom.i160826.ucus.impl.ActorImpl#getName <em>Name</em>}</li>
 *   <li>{@link pt.isep.edom.i160826.ucus.impl.ActorImpl#getAssociation <em>Association</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ActorImpl extends MinimalEObjectImpl.Container implements Actor {
	...
	protected EClass eStaticClass() {
		return UcusPackage.Literals.ACTOR;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UcusPackage.ACTOR__NAME, oldName, name));
	}
	...
	public EList<Association> getAssociation() {
		if (association == null) {
			association = new EObjectWithInverseResolvingEList<Association>(Association.class, this,
					UcusPackage.ACTOR__ASSOCIATION, UcusPackage.ASSOCIATION__ACTOR);
		}
		return association;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case UcusPackage.ACTOR__ASSOCIATION:
