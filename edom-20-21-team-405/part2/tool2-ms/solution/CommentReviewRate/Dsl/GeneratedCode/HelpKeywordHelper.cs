...
namespace EDOM.CommentReviewRate
{
	...
	/// </remarks>
	public partial class CommentReviewRateHelpKeywordHelper : CommentReviewRateHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new CommentReviewRateHelpKeywordHelper.
		/// </summary>
		protected CommentReviewRateHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the CommentReviewRateHelpKeywordHelper.
		/// </summary>
		public static CommentReviewRateHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class CommentReviewRateHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new CommentReviewRateHelpKeywordHelperBase.
		/// </summary>
		protected CommentReviewRateHelpKeywordHelperBase()
			: base() { }
