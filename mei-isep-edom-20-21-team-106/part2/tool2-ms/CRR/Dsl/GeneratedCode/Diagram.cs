...
namespace Edom.CRR
{
	...
	public partial class CRRDiagram : DslDiagrams::Diagram
	{
		...
		protected override DslDiagrams::ShapeElement CreateChildShape(DslModeling::ModelElement element)
		{
			...
			{
				global::Edom.CRR.ItemElementShape newShape = new global::Edom.CRR.ItemElementShape(this.Partition);
			...
			{
				global::Edom.CRR.DataTypeElementShape newShape = new global::Edom.CRR.DataTypeElementShape(this.Partition);
				if(newShape != null) newShape.Size = newShape.DefaultSize; // set default shape size
				return newShape;
			}
			if(element is global::Edom.CRR.ApprovalProcess)
			{
				global::Edom.CRR.ApprovalProcessElementShape newShape = new global::Edom.CRR.ApprovalProcessElementShape(this.Partition);
				if(newShape != null) newShape.Size = newShape.DefaultSize; // set default shape size
				return newShape;
			}
			if(element is global::Edom.CRR.User)
			{
				global::Edom.CRR.UserElementShape newShape = new global::Edom.CRR.UserElementShape(this.Partition);
				if(newShape != null) newShape.Size = newShape.DefaultSize; // set default shape size
				return newShape;
			}
			if(element is global::Edom.CRR.Comment)
			{
				global::Edom.CRR.CommentElementShape newShape = new global::Edom.CRR.CommentElementShape(this.Partition);
				if(newShape != null) newShape.Size = newShape.DefaultSize; // set default shape size
				return newShape;
			}
			if(element is global::Edom.CRR.Rate)
			{
				global::Edom.CRR.RateElementShape newShape = new global::Edom.CRR.RateElementShape(this.Partition);
				if(newShape != null) newShape.Size = newShape.DefaultSize; // set default shape size
				return newShape;
			}
			if(element is global::Edom.CRR.Review)
			{
				global::Edom.CRR.ReviewElementShape newShape = new global::Edom.CRR.ReviewElementShape(this.Partition);
				if(newShape != null) newShape.Size = newShape.DefaultSize; // set default shape size
				return newShape;
			}
			if(element is global::Edom.CRR.ApprovalStart)
			{
				global::Edom.CRR.ApprovalStartElementShape newShape = new global::Edom.CRR.ApprovalStartElementShape(this.Partition);
				if(newShape != null) newShape.Size = newShape.DefaultSize; // set default shape size
				return newShape;
			}
			if(element is global::Edom.CRR.ApprovalStep)
			{
				global::Edom.CRR.ApprovalStepElementShape newShape = new global::Edom.CRR.ApprovalStepElementShape(this.Partition);
				if(newShape != null) newShape.Size = newShape.DefaultSize; // set default shape size
				return newShape;
			}
			if(element is global::Edom.CRR.ItemReferencesAttributes)
			{
				global::Edom.CRR.ElementsConnector newShape = new global::Edom.CRR.ElementsConnector(this.Partition);
				return newShape;
			}
			...
			if(element is global::Edom.CRR.CommentReferencesUsers)
			{
				global::Edom.CRR.ElementsConnector newShape = new global::Edom.CRR.ElementsConnector(this.Partition);
				return newShape;
			}
			...
			if(element is global::Edom.CRR.RateReferencesUsers)
			{
				global::Edom.CRR.ElementsConnector newShape = new global::Edom.CRR.ElementsConnector(this.Partition);
				return newShape;
			}
			...
			if(element is global::Edom.CRR.ApprovalStepReferencesTargetScucessStep)
			{
				global::Edom.CRR.ElementsConnector newShape = new global::Edom.CRR.ElementsConnector(this.Partition);
				return newShape;
			}
			...
			if(element is global::Edom.CRR.ApprovalStepReferencesTargetFailureStep)
			{
				global::Edom.CRR.ElementsConnector newShape = new global::Edom.CRR.ElementsConnector(this.Partition);
				return newShape;
			}
		...
		protected override void InitializeShapeFields(global::System.Collections.Generic.IList<DslDiagrams::ShapeField> shapeFields)
		{
			...
			global::Edom.CRR.ItemElementShape.DecoratorsInitialized += ItemElementShapeDecoratorMap.OnDecoratorsInitialized;
			global::Edom.CRR.AttributesShape.DecoratorsInitialized += AttributesShapeDecoratorMap.OnDecoratorsInitialized;
			global::Edom.CRR.DataTypeElementShape.DecoratorsInitialized += DataTypeElementShapeDecoratorMap.OnDecoratorsInitialized;
			global::Edom.CRR.ApprovalProcessElementShape.DecoratorsInitialized += ApprovalProcessElementShapeDecoratorMap.OnDecoratorsInitialized;
			global::Edom.CRR.UserElementShape.DecoratorsInitialized += UserElementShapeDecoratorMap.OnDecoratorsInitialized;
			global::Edom.CRR.CommentElementShape.DecoratorsInitialized += CommentElementShapeDecoratorMap.OnDecoratorsInitialized;
			global::Edom.CRR.RateElementShape.DecoratorsInitialized += RateElementShapeDecoratorMap.OnDecoratorsInitialized;
			global::Edom.CRR.ReviewElementShape.DecoratorsInitialized += ReviewElementShapeDecoratorMap.OnDecoratorsInitialized;
			global::Edom.CRR.ApprovalStartElementShape.DecoratorsInitialized += ApprovalStartElementShapeDecoratorMap.OnDecoratorsInitialized;
			global::Edom.CRR.ApprovalStepElementShape.DecoratorsInitialized += ApprovalStepElementShapeDecoratorMap.OnDecoratorsInitialized;
		}
		
		/// <summary>
		/// Class containing decorator path traversal methods for ItemElementShape.
		/// </summary>
		internal static partial class ItemElementShapeDecoratorMap
		{
			/// <summary>
			/// Event handler called when decorator initialization is complete for ItemElementShape.  Adds decorator mappings for this shape or connector.
			/// </summary>
		...
		/// <summary>
		/// Class containing decorator path traversal methods for DataTypeElementShape.
		/// </summary>
		internal static partial class DataTypeElementShapeDecoratorMap
		{
			/// <summary>
			/// Event handler called when decorator initialization is complete for DataTypeElementShape.  Adds decorator mappings for this shape or connector.
			/// </summary>
			public static void OnDecoratorsInitialized(object sender, global::System.EventArgs e)
			{
				DslDiagrams::ShapeElement shape = (DslDiagrams::ShapeElement)sender;
		...
		/// <summary>
		/// Class containing decorator path traversal methods for ApprovalProcessElementShape.
		/// </summary>
		internal static partial class ApprovalProcessElementShapeDecoratorMap
		{
			/// <summary>
			/// Event handler called when decorator initialization is complete for ApprovalProcessElementShape.  Adds decorator mappings for this shape or connector.
			/// </summary>
			public static void OnDecoratorsInitialized(object sender, global::System.EventArgs e)
			{
				DslDiagrams::ShapeElement shape = (DslDiagrams::ShapeElement)sender;
		...
		/// <summary>
		/// Class containing decorator path traversal methods for UserElementShape.
		/// </summary>
		internal static partial class UserElementShapeDecoratorMap
		{
			/// <summary>
			/// Event handler called when decorator initialization is complete for UserElementShape.  Adds decorator mappings for this shape or connector.
			/// </summary>
			public static void OnDecoratorsInitialized(object sender, global::System.EventArgs e)
			{
				DslDiagrams::ShapeElement shape = (DslDiagrams::ShapeElement)sender;
		...
		/// <summary>
		/// Class containing decorator path traversal methods for CommentElementShape.
		/// </summary>
		internal static partial class CommentElementShapeDecoratorMap
		{
			/// <summary>
			/// Event handler called when decorator initialization is complete for CommentElementShape.  Adds decorator mappings for this shape or connector.
			/// </summary>
			public static void OnDecoratorsInitialized(object sender, global::System.EventArgs e)
			{
				DslDiagrams::ShapeElement shape = (DslDiagrams::ShapeElement)sender;
		...
		/// <summary>
		/// Class containing decorator path traversal methods for RateElementShape.
		/// </summary>
		internal static partial class RateElementShapeDecoratorMap
		{
			/// <summary>
			/// Event handler called when decorator initialization is complete for RateElementShape.  Adds decorator mappings for this shape or connector.
			/// </summary>
			public static void OnDecoratorsInitialized(object sender, global::System.EventArgs e)
			{
				DslDiagrams::ShapeElement shape = (DslDiagrams::ShapeElement)sender;
		...
		/// <summary>
		/// Class containing decorator path traversal methods for ReviewElementShape.
		/// </summary>
		internal static partial class ReviewElementShapeDecoratorMap
		{
			/// <summary>
			/// Event handler called when decorator initialization is complete for ReviewElementShape.  Adds decorator mappings for this shape or connector.
			/// </summary>
			public static void OnDecoratorsInitialized(object sender, global::System.EventArgs e)
			{
				DslDiagrams::ShapeElement shape = (DslDiagrams::ShapeElement)sender;
		...
		/// <summary>
		/// Class containing decorator path traversal methods for ApprovalStartElementShape.
		/// </summary>
		internal static partial class ApprovalStartElementShapeDecoratorMap
		{
			/// <summary>
			/// Event handler called when decorator initialization is complete for ApprovalStartElementShape.  Adds decorator mappings for this shape or connector.
			/// </summary>
			public static void OnDecoratorsInitialized(object sender, global::System.EventArgs e)
			{
				DslDiagrams::ShapeElement shape = (DslDiagrams::ShapeElement)sender;
		...
		/// <summary>
		/// Class containing decorator path traversal methods for ApprovalStepElementShape.
		/// </summary>
		internal static partial class ApprovalStepElementShapeDecoratorMap
		{
			/// <summary>
			/// Event handler called when decorator initialization is complete for ApprovalStepElementShape.  Adds decorator mappings for this shape or connector.
			/// </summary>
			public static void OnDecoratorsInitialized(object sender, global::System.EventArgs e)
			{
				DslDiagrams::ShapeElement shape = (DslDiagrams::ShapeElement)sender;
		...
		private global::Edom.CRR.ApprovalStepHasSuccessStepConnectAction approvalStepHasSuccessStepConnectAction;
		private global::Edom.CRR.ApprovalStepHasFailureStepConnectAction approvalStepHasFailureStepConnectAction;
		/// <summary>
		...
		public override void OnViewMouseEnter(DslDiagrams::DiagramPointEventArgs pointArgs)
		{
			...
			if(activeView != null)
			{
				...
				else if (SelectedToolboxItemSupportsFilterString(activeView, global::Edom.CRR.CRRToolboxHelper.ApprovalStepHasSuccessStepFilterString))
				{
					if (this.approvalStepHasSuccessStepConnectAction == null)
					{
						this.approvalStepHasSuccessStepConnectAction = new global::Edom.CRR.ApprovalStepHasSuccessStepConnectAction(this);
						this.approvalStepHasSuccessStepConnectAction.MouseActionDeactivated += new DslDiagrams::MouseAction.MouseActionDeactivatedEventHandler(OnConnectActionDeactivated);
					}
					action = this.approvalStepHasSuccessStepConnectAction;
				} 
				else if (SelectedToolboxItemSupportsFilterString(activeView, global::Edom.CRR.CRRToolboxHelper.ApprovalStepHasFailureStepFilterString))
				{
					if (this.approvalStepHasFailureStepConnectAction == null)
					{
						this.approvalStepHasFailureStepConnectAction = new global::Edom.CRR.ApprovalStepHasFailureStepConnectAction(this);
						this.approvalStepHasFailureStepConnectAction.MouseActionDeactivated += new DslDiagrams::MouseAction.MouseActionDeactivatedEventHandler(OnConnectActionDeactivated);
					}
					action = this.approvalStepHasFailureStepConnectAction;
				} 
				else
				{
					action = null;
		...
		protected override void Dispose(bool disposing)
		{
			try
			{
				if(disposing)
				{
					...
					if(this.approvalStepHasSuccessStepConnectAction != null)
					{
						this.approvalStepHasSuccessStepConnectAction.Dispose();
						this.approvalStepHasSuccessStepConnectAction = null;
					}
					if(this.approvalStepHasFailureStepConnectAction != null)
					{
						this.approvalStepHasFailureStepConnectAction.Dispose();
						this.approvalStepHasFailureStepConnectAction = null;
					}
				}
			}
			finally
...
namespace Edom.CRR
{
		...
		[DslModeling::RuleOn(typeof(global::Edom.CRR.ApprovalStepReferencesTargetScucessStep), FireTime = DslModeling::TimeToFire.TopLevelCommit, Priority = DslDiagrams::DiagramFixupConstants.AddConnectionRulePriority, InitiallyDisabled=true)]
		...
		[DslModeling::RuleOn(typeof(global::Edom.CRR.RateReferencesUsers), FireTime = DslModeling::TimeToFire.TopLevelCommit, Priority = DslDiagrams::DiagramFixupConstants.AddConnectionRulePriority, InitiallyDisabled=true)]
		...
		[DslModeling::RuleOn(typeof(global::Edom.CRR.CommentReferencesUsers), FireTime = DslModeling::TimeToFire.TopLevelCommit, Priority = DslDiagrams::DiagramFixupConstants.AddConnectionRulePriority, InitiallyDisabled=true)]
		...
		[DslModeling::RuleOn(typeof(global::Edom.CRR.ApprovalStepReferencesTargetFailureStep), FireTime = DslModeling::TimeToFire.TopLevelCommit, Priority = DslDiagrams::DiagramFixupConstants.AddConnectionRulePriority, InitiallyDisabled=true)]
