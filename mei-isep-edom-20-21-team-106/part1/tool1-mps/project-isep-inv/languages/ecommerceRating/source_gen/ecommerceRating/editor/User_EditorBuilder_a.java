...
/*package*/ class User_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new AttributesListHandler_1jbsxc_c3a(myNode, getEditorContext());
  ...
  private static class AttributesListHandler_1jbsxc_c3a extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public AttributesListHandler_1jbsxc_c3a(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(AttributesListHandler_1jbsxc_c3a.this.getNode(), LINKS.Attributes$DC3n));
      try {
