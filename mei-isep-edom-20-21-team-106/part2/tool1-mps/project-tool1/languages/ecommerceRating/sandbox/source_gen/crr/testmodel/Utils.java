...
public class Utils {
  public static void createComment(IUser user) {
    ...
    Product item = getProductById(Integer.parseInt(itemId));
    if (item == null) {
    ...
    comment.Author = user;
    comment.Approved = ApprovalComment.initApprovalProcess(comment);
  ...
  public static void createRate(IUser user) {
    ...
    rate.Author = user;
    rate.Approved = RateApproval.initApprovalProcess(rate);
    item.Rates.add(rate);
  }

  public static void displayItems() {
    for (int i = 0; i < TestModel.Products.size(); i++) {
      System.out.println(TestModel.Products.get(i));
      System.out.println("=======================");
    }
  }
  ...
  private static Product getProductById(int id) {
    ...
    for (int i = 0; i < TestModel.Products.size(); i++) {
      if (TestModel.Products.get(i).Id == id) {
        itemSelected = TestModel.Products.get(i);
        break;
      }
    }
