...
namespace Edom.CRR
{
	...
	/// </summary>
	internal partial class CRRCommandSet : CRRCommandSetBase
	{
		/// <summary>
		/// Constructs a new CRRCommandSet.
		/// </summary>
		public CRRCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class CRRCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new CRRCommandSetBase.
		/// </summary>
		protected CRRCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewCRRExplorerCommand,
				typeof(CRREditorFactory).GUID);
		...
		{
			CRRExplorerToolWindow explorer = this.CRRExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		{
			if (this.CurrentCRRDocData != null && this.CurrentCRRDocData.Store != null)
			{
				this.CurrentCRRDocData.ValidationController.Validate(this.CurrentCRRDocData.GetAllElementsForValidation(), DslValidation::ValidationCategories.Menu);
			}
		}
		...
		internal virtual void OnMenuValidate(object sender, global::System.EventArgs e)
		{
			if (this.CurrentCRRDocData != null && this.CurrentCRRDocData.Store != null)
			{
				...
				this.CurrentCRRDocData.ValidationController.Validate(elementList, DslValidation::ValidationCategories.Menu);
			}
		}
		...
		protected CRRDocData CurrentCRRDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as CRRDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected CRRDocView CurrentCRRDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as CRRDocView;
			}
		}
		...
		/// </summary>
		protected CRRExplorerToolWindow CRRExplorerToolWindow
		{
			get
			{
				CRRExplorerToolWindow explorerWindow = null;
				DslShell::ModelingPackage package = this.ServiceProvider.GetService(typeof(VSShell::Package)) as DslShell::ModelingPackage;

				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(CRRExplorerToolWindow), true) as CRRExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				CRRExplorerToolWindow explorerWindow = this.CRRExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class CRRClipboardCommandSet : CRRClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new CRRClipboardCommandSet.
		/// </summary>
		public CRRClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class CRRClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new CRRClipboardCommandSetBase.
		/// </summary>
		protected CRRClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
