...
public class Model2Model {
	...
	public static void main(String[] args) {
		...
		model2ModelTransformation("generateuml", "http://www.example.org/edom405epsilon", UMLPackage.eINSTANCE.eNS_URI, "instances/example1.edom405epsilon", "instances/example1-output.uml");
