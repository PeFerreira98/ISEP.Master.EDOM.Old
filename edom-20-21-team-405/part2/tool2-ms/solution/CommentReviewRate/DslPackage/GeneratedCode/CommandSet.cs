...
namespace EDOM.CommentReviewRate
{
	...
	/// </summary>
	internal partial class CommentReviewRateCommandSet : CommentReviewRateCommandSetBase
	{
		/// <summary>
		/// Constructs a new CommentReviewRateCommandSet.
		/// </summary>
		public CommentReviewRateCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class CommentReviewRateCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new CommentReviewRateCommandSetBase.
		/// </summary>
		protected CommentReviewRateCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewCommentReviewRateExplorerCommand,
				typeof(CommentReviewRateEditorFactory).GUID);
		...
		{
			CommentReviewRateExplorerToolWindow explorer = this.CommentReviewRateExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		{
			if (this.CurrentCommentReviewRateDocData != null && this.CurrentCommentReviewRateDocData.Store != null)
			{
				this.CurrentCommentReviewRateDocData.ValidationController.Validate(this.CurrentCommentReviewRateDocData.GetAllElementsForValidation(), DslValidation::ValidationCategories.Menu);
			}
		}
		...
		internal virtual void OnMenuValidate(object sender, global::System.EventArgs e)
		{
			if (this.CurrentCommentReviewRateDocData != null && this.CurrentCommentReviewRateDocData.Store != null)
			{
				...
				this.CurrentCommentReviewRateDocData.ValidationController.Validate(elementList, DslValidation::ValidationCategories.Menu);
			}
		}
		...
		protected CommentReviewRateDocData CurrentCommentReviewRateDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as CommentReviewRateDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected CommentReviewRateDocView CurrentCommentReviewRateDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as CommentReviewRateDocView;
			}
		}
		...
		/// </summary>
		protected CommentReviewRateExplorerToolWindow CommentReviewRateExplorerToolWindow
		{
			get
			{
				CommentReviewRateExplorerToolWindow explorerWindow = null;
				DslShell::ModelingPackage package = this.ServiceProvider.GetService(typeof(VSShell::Package)) as DslShell::ModelingPackage;

				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(CommentReviewRateExplorerToolWindow), true) as CommentReviewRateExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				CommentReviewRateExplorerToolWindow explorerWindow = this.CommentReviewRateExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class CommentReviewRateClipboardCommandSet : CommentReviewRateClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new CommentReviewRateClipboardCommandSet.
		/// </summary>
		public CommentReviewRateClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class CommentReviewRateClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new CommentReviewRateClipboardCommandSetBase.
		/// </summary>
		protected CommentReviewRateClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
