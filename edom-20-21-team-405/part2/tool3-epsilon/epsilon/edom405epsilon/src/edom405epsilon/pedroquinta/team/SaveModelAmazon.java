...
public class SaveModelAmazon {
	...
	// Example of how to use the EMF library
		...
		public static void saveModel() {
	        ...
	        firstCommentField1.setType(FieldTypes.STRING);
	        
	        Field secondCommentField1 = factory.createField();
	        secondCommentField1.setName("date");
	        secondCommentField1.setType(FieldTypes.DATE);
	        
	        Field thirdCommentField1 = factory.createField();
	        thirdCommentField1.setName("description");
	        thirdCommentField1.setType(FieldTypes.STRING);
	        
	        
	        //Create Comment Fields
	        secondComment.getField().add(firstCommentField1);
	        secondComment.getField().add(secondCommentField1);
	        secondComment.getField().add(thirdCommentField1);
	        ...
	        subjectField.setType(FieldTypes.INTEGER);
	        ...
	        Resource resource = resSet.createResource(URI.createURI("instances/amazon.edomEpsilon"));
