...
namespace Company.UCUS
{
	...
	/// </summary>
	internal partial class UCUSExplorer : UCUSExplorerBase
	{
		/// <summary>
		/// Constructs a new UCUSExplorer.
		/// </summary>
		public UCUSExplorer(global::System.IServiceProvider serviceProvider)
	...
	/// <summary>
	/// Control hosted in the UCUSExplorerToolWindow.
	/// </summary>
	internal abstract class UCUSExplorerBase : DslShell::ModelExplorerTreeContainer
	{
		/// <summary>
		/// Constructs a new UCUSExplorerBase.
		/// </summary>
		protected UCUSExplorerBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuCommandId
		{
			get
			{
				return Constants.UCUSExplorerMenu;
			}
		}
		...
		{
			get { return global::Company.UCUS.Model.DomainClassId; }
		}
